    ...
    <div>
      <section className="mb-10">
        <div className="container py-10">
          <div className="bg-gradient-to-r from-indigo-600 to-sky-500 text-white px-8 py-10 rounded-2xl shadow-lg">
            <h1 className="text-4xl md:text-5xl font-extrabold">Historia Argentina</h1>
